...
So I have been planning this for a while, but I have finally gotten around to it. There are currently 3 main pages, `About Me`, `Portfolio`, and a `Resume`, in the works for the past 2 weeks, and I finally have sufficent progress to warrant a post and a push it up to production.
